...
#MARYAM
TRIGGER_M = re.compile(r"\b(good\s?girl|mommy|shawty|bitch|whore|goodgirl|kys|hoe|slut|faggot|badgirl|shawty|baby|babe|bae|pookie|bad\s?girl|blow\s?me|give\s?head)\b", re.IGNORECASE)
